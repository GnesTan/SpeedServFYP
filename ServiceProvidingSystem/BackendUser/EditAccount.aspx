       ...
       <b><u>Edit User</u></b>
        ...
        <table class="tbDetails">
            ...
            <tr style="padding-bottom:20px;">
                ...
                <td>
                    <asp:RegularExpressionValidator style="color:red" runat="server" ID="PasswordMin" ControlToValidate = "txtPassword" ValidationExpression = "^[\s\S]{6,}$" ErrorMessage="Minimum 6 characters required." ValidationGroup="EditAccount"></asp:RegularExpressionValidator>
                </td>
            </tr>
            ...
            <tr style="padding-bottom:30px;">
                ...
                <td>
                    <asp:CompareValidator ID="NewPasswordCompare" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtConPass" Display="Dynamic" ErrorMessage="The Confirm Password must match the Password entry." ValidationGroup="EditAccount" ForeColor="red"></asp:CompareValidator>
                </td>
            </tr>
            ...
            <asp:Button ID="btnConfirm" runat="server" class="btnNew btn-primary btn-lg" OnClick="btnConfirm_Click" Text="Save" ValidationGroup="CreateAccount" />
            &nbsp;&nbsp;&nbsp;
