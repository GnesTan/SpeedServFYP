...
{
    public partial class SubscriptionVolumeReport : System.Web.UI.Page
    {
        ...
        {
            //get username and date from session
            String strUsername = "";
            ...
            {
                //retrieve data
                String strSelect = "SELECT * FROM " + table + " WHERE status = 'D' AND (CONVERT(DATETIME, date_and_time, 103) >= CONVERT(DATETIME, @from_date, 103) AND CONVERT(DATETIME, date_and_time, 103) < CONVERT(DATETIME, @to_date, 103));";
                ...
                r.Load(Server.MapPath("~/Reports/SubscriptionVolumeReport.rpt"));
                ...
                r.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Subscription Volume Report");
