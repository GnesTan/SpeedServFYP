<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ClientPayment.aspx.cs" Inherits="ServiceProvidingSystem.BackendUser.ClientPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <div class="topicName">
        <br />
        <br />
        <b><u>Client Payment</u></b>&nbsp&nbsp&nbsp<a href ="ClientPayment.aspx"  class="btnNew btn-primary btn-lg" > Refresh</a>
    </div>
                    ...
                    <table class="tblStyle">
                        <tr>
                            ...
                            <td style="width:230px;">
                                <asp:Label ID="lblTransferNo" runat="server" Font-Bold="true" ForeColor="Black" Text='<%# Eval("transfer_no") %>'></asp:Label>
                            </td>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td style="width:230px;">
                                <asp:Label ID="lblClientId" runat="server" Font-Bold="true" ForeColor="Black" Text='<%# Eval("client_id") %>'></asp:Label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width:160px;">
                                <b>RM</b><asp:Label ID="Label2" runat="server" Font-Bold="true" ForeColor="Black" Text='<%# Eval("amount_charges") %>'></asp:Label>
                            </td>
                            <td style="width:200px;">
                                Pending
                            </td>
            ...
            <br>
                    ...
                    <asp:Panel ID="NonePanel" runat="server" Visible="false">
                       <div class="noItemContainer">
                            ...
                            <br /><br />
                            <h3><asp:Label ID="noItemText" runat="server" Text="There is currently no transfer from client, please try to refresh later."></asp:Label></h3>
                            <br />
                        <asp:LinkButton  ID="noItemLinkText" class="noItemLinkText" runat="server" PostBackUrl="~/BackendUser/ClientPayment.aspx">Refresh</asp:LinkButton>
                       </div> 
