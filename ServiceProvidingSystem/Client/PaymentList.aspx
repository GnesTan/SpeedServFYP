<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="PaymentList.aspx.cs" Inherits="ServiceProvidingSystem.Client.PaymentList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <div class="container">
        ...
        <div class="row mb-4 px-2">
            <div class="col-md-6">
                <h1 data-aos="fade-right"><span style="">P</span>ay Services</h1>
            </div>
        ...
        <div class="row shadow px-3 mx-3 py-3 bg-white rounded">
            ...
            <ContentTemplate>                                        
                            <div class="row px-2 py-2">
                                <div class="col">
                                    <div class="reqStatusMargin col-sm px-2 py-1">      
                                        ...
                                        <asp:Repeater ID="displayPayListRep" runat="server" >                                                   
                                        <ItemTemplate>
                                                           ...
                                                           <div class="col-md-8 py-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col md-4">
                                                                        ...
                                                                        <asp:Label ID="lblStatus" runat="server" class="reqDetailsLabel status align-middle" Font-Strikeout="False" Text='<%# (string)Eval("status") =="W" ? "Pending Payment" : "Verifying Payment" %>'></asp:Label>
                                                                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Eval("request_no") %>'></asp:HiddenField>
                                                                    </div>              
                                                                    <div class="col md-6">
                                                                         <h4 for="name" class="form-label align-middle">Total Amount</h4>
                                                                        <asp:Label ID="lblPrice" runat="server" class="reqDetailsLabel status align-middle" Text='<%# "RM " + Eval("amount_charges") %>'></asp:Label>
                                                                    </div>
                                                                </div>                                                                                                            
                                                            </div>
                                                                ...
                                                                <div class="row ">
                                                                    <div class="col-md-12">
                                                                        <div class="text-end text-lg-flex justify-content-center">  
                                                                            <asp:LinkButton ID="LinkButton2" class="btn-find-now btnRefresh d-inline-flex align-items-center justify-content-center align-self-center" runat="server" OnClick="btnViewPayment_Click">  
                            ...
                            <asp:Image ID="noItemLogo" runat="server" ImageUrl="~/Image/—Pngtree—info vector icon_3791375.png" class="noItemLogo" />            
                                <br /><br />
                            <h3><asp:Label ID="noItemText" runat="server" Text="Currently no payment records" style="font-size: 30px;"></asp:Label></h3>
                                <br />
                    ...
                    <Triggers>  
                    <asp:AsyncPostBackTrigger ControlID ="displayPayListRep" />  
                    </Triggers>  
            </asp:UpdatePanel>
            </div>
        </div>
