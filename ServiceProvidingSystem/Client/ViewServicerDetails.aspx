<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewServicerDetails.aspx.cs" Inherits="ServiceProvidingSystem.Client.ViewServicerDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <link href="../ViewServicerDetails.css" rel="stylesheet" />

    <asp:ScriptManager ID="ScriptManager1" runat="server">  
    </asp:ScriptManager> 

    <section id="#" class="viewServDet d-flex align-items-center">
    <div class="container">
        ...
        <div class="reqStatusMargin col-sm px-5 py-3">      
            <div class="row">
                <div class="col-md-5 py-2">
                    <asp:Image ID="imgProfile" runat="server" Height="130px" Width="130px" style="border-radius:100px; box-shadow: 0 0 0 3px #b3b3b3; text-decoration:none;" ImageUrl="~/Image/Foto_Formal.jpg" />
                </div>
                <div class="col-md-7">
                    <div class="row mb-3">
            ...
            <hr />
                <div class="row g-3">     
                    <div class="text-end text-lg-flex justify-content-center" data-aos="zoom-out" data-aos-delay="50" >                        
                        <asp:LinkButton ID="LinkButton1" class="btn-find-now btnRefresh d-inline-flex align-items-center justify-content-center align-self-center" runat="server" OnClick="lbViewMoreDetails_Click">  
                        <span>View More</span>
