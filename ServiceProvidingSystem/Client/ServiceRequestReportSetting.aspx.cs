...
{
    public partial class ServiceRequestReportSetting : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.TryParse(txtFrom.Text, out dateValue) && DateTime.TryParse(txtTo.Text, out dateValue))
            {
                ...
                //redirect to report
                ClientScript.RegisterStartupScript(this.Page.GetType(), "", "window.open('ServiceRequestReport.aspx');", true);
