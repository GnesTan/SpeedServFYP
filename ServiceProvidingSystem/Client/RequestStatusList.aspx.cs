...
{
    public partial class RequestStatusList : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            con.Open();
            //retrieve data
            String strSelect = "SELECT * FROM SERVICE_REQUEST WHERE CLIENT_ID = @strId AND (STATUS = 'L' OR STATUS = 'S') ORDER BY DATE_AND_TIME DESC";
            ...
            displayRequestedServRep.DataSource = dtrFav;
            displayRequestedServRep.DataBind();
            con.Close();
        }
