<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TransactionReportSetting.aspx.cs" Inherits="ServiceProvidingSystem.Client.TransactionReportSetting" %>
            ...
            <div data-aos="zoom-out" data-aos-delay="100">  
                <div class="shadow p-5 mb-5 bg-white rounded" data-aos="zoom-out" data-aos-delay="50" >   
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row mb-4">
                                <h3 data-aos="fade-right"><span style="">T</span>ransaction Report Date Range</h3>
                            </div>
                            <div class="row mb-4">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">  
                                    <asp:CompareValidator ID="CompareValidator1" ValidationGroup = "Date" ForeColor = "Red" runat="server" ControlToValidate = "txtFrom" ControlToCompare = "txtTo" Operator = "LessThanEqual" Type = "Date" ErrorMessage="*To date must be more than or equal From date."></asp:CompareValidator>                                    
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-md-12">                                      
