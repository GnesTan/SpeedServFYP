<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewTransactionDetails.aspx.cs" Inherits="ServiceProvidingSystem.Client.ViewTransactionDetails" %>
                ...
                <div class="shadow p-5 mb-5 bg-white rounded" data-aos="zoom-out" data-aos-delay="50" >       
                    <div class="row mb-1">                        
                        <div class="col-md-12 my-1 d-flex justify-content-center">
                            <h2 for="name" class="form-label">Transaction Details</h2>
                        </div>
                        <div class="col-md-12 my-1 d-flex justify-content-center">
                    ...
                    <div class="row g-3">     
                        <div class="text-end text-lg-flex justify-content-center">  
                            <asp:LinkButton ID="btnBack" class="btn-find-now btnReview d-inline-flex align-items-center justify-content-center align-self-center" runat="server" OnClick="btnBack_Click">  
                            <span>Back</span>                                
                            </asp:LinkButton>      
                            
                            <asp:LinkButton ID="btnViewServDetails" class="btn-find-now btnReview d-inline-flex align-items-center justify-content-center align-self-center" runat="server" OnClick="btnViewServiceDetails_Click">  
