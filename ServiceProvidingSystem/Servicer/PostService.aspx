...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PostService.aspx.cs" Inherits="ServiceProvidingSystem.Servicer.PostService" %>
       ...
       <b><u>Post Service</u></b>
        ...
        <table class="tbDetails">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtServiceTitle" runat="server"></asp:TextBox>
            ...
            <tr style="padding-bottom:20px;">
                ...
                <td>
                     <asp:UpdatePanel ID="districtpanel" runat="server">      
                        <ContentTemplate>   
                            <asp:DropDownList ID="ddldistrict" runat="server" AutoPostBack="true" AppendDataBoundItems="true" Width="200px" Height="30px"></asp:DropDownList>
                        </ContentTemplate>  
                        <Triggers>  
            ...
            <tr style="padding-bottom:30px;">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator style="color:red" ID="RequiredFees" runat="server" ControlToValidate="txtFees" ErrorMessage="Fees is required." ToolTip="Fees is required." ValidationGroup="PostService">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <asp:Button ID="btnPost" runat="server" class="btnNew btn-primary btn-lg" Text="Post" ValidationGroup="PostService" OnClick="btnPost_Click" />
            &nbsp;&nbsp;&nbsp;
