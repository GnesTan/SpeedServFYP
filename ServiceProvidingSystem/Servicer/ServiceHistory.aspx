<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ServiceHistory.aspx.cs" Inherits="ServiceProvidingSystem.Servicer.ServiceHistory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <div class="topicName">
        <br />
        <br />
        <b><u>Service History</u></b>&nbsp&nbsp&nbsp<a href ="ServiceHistory.aspx"  class="btnNew btn-primary btn-lg" > Refresh</a>
    </div>
                ...
                <div class="rowMargin">
                    <table class="tblStyle">
                        ...
                        <tr>
                            ...
                            <td style="width:200px;">
                                <asp:Label ID="lblStatus" runat="server" Font-Bold="true" ForeColor="Black" Text='<%# (string)Eval("status") =="D" ? "Completed" :"Cancelled" %>'></asp:Label>
                            </td>
            ...
            <%# Container.DataItem %>
                    ...
                    <asp:Panel ID="NonePanel" runat="server" Visible="false">
                       <div class="noItemContainer">
                            ...
                            <br /><br />
                            <h3><asp:Label ID="noItemText" runat="server" Text="Currently there are no any service record found."></asp:Label></h3>
                            <br />
