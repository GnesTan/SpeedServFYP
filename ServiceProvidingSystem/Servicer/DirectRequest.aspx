...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DirectRequest.aspx.cs" Inherits="ServiceProvidingSystem.Servicer.DirectRequest" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="topicName">
            <br />
            <br />
            <b><u>Direct Request</u></b>&nbsp&nbsp&nbsp<asp:LinkButton ID="lbRefresh" runat="server" class="btnNew btn-primary btn-lg" OnClick="lbRefresh_Click"> Refresh</asp:LinkButton> &nbsp&nbsp&nbsp
        </div>
            ...
            <%# Container.DataItem %>
                    ...
                    <asp:Panel ID="NonePanel" runat="server" Visible="false">
                       <div class="noItemContainer">
                            ...
                            <br /><br />
                            <h3><asp:Label ID="noItemText" runat="server" Text="There is currently no direct request from client, please try to refresh later."></asp:Label></h3>
                            <br />
                    ...
                    <asp:Panel ID="ExpiredPanel" runat="server" Visible="false">
                       <div class="noItemContainer">
                            ...
                            <br /><br />
                            <h3><asp:Label ID="Label1" runat="server" Text="Your subscription validity currently is not active, please subscription to view client direct request."></asp:Label></h3>
                            <br />
                       </div> 
