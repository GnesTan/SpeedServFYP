...
namespace ServiceProvidingSystem.Servicer
{
    public partial class RequestList : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            con.Open();
            //retrieve data
            String strSelect = "SELECT S.request_no, S.date_and_time, S.service_category, S.service_type, S.state, S.status, S.district, C.full_name FROM Service_Request S, Client C WHERE S.client_id = C.client_id AND S.status = 'L';";
